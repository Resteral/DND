    ...
    <div className="landing-container" style={{ 
      ...
      <div style={{ position: 'absolute', top: 0, left: 0, width: '100%', height: '100%', opacity: 0.2, pointerEvents: 'none' }}>
         {[...Array(20)].map((_, i) => (
           <motion.div 
             key={i}
             animate={{ y: [0, -100, 0], opacity: [0.2, 0.5, 0.2], scale: [1, 1.2, 1] }}
             transition={{ duration: 5 + Math.random() * 5, repeat: Infinity }}
             style={{ position: 'absolute', top: `${Math.random() * 100}%`, left: `${Math.random() * 100}%`, width: '2px', height: '2px', background: 'var(--accent-gold)', borderRadius: '50%' }}
           />
         ))}
      </div>

      <motion.div initial={{ y: -50, opacity: 0 }} animate={{ y: 0, opacity: 1 }} style={{ textAlign: 'center', marginBottom: '4rem', zIndex: 10 }}>
      ...
      <div style={{ display: 'flex', gap: '2rem', zIndex: 10 }}>
        <motion.div 
          ...
          className="panel"
          style={{ width: '300px', padding: '2.5rem', cursor: 'pointer', textAlign: 'center', border: '1.5px solid var(--accent-purple)' }}
        ...
        <motion.div 
          whileHover={{ scale: 1.05, y: -10 }}
          className="panel"
          style={{ width: '300px', padding: '2.5rem', cursor: 'pointer', textAlign: 'center', border: '1.5px solid var(--accent-gold)' }}
        ...
        <motion.div 
          whileHover={{ scale: 1.05, y: -10 }}
          className="panel"
          style={{ width: '300px', padding: '2.5rem', cursor: 'pointer', textAlign: 'center', border: '1.5px solid #4eb2ff' }}
          onClick={() => navigate('/session?room=party-lobby')}
        >
      ...
      <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }} transition={{ delay: 1 }} style={{ marginTop: '4rem', zIndex: 10 }}>
